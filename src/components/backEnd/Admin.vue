<template lang="html">
  <el-row class="panel">
      ...
      <el-col :span='23' class="panel-top" :push="1">
        ...
        <!--  offset设置的是margin-lef-->
          <el-col :span="20" style='font-size:26px'>
            <span class='controller'>飞雪玉花台</span>
          </el-col>
          <el-col :span='4' class='rightbar'>
            <el-dropdown trigger="click">
              <span class="el-dropdown-link" style="color:#fff;cursor: pointer;font-weight:700">
    ...
    <el-row  class="panel-center">
      <el-col :span="5">
        <el-menu  theme="light"  router :default-active="currentPath">
...
<style scoped>
  ...
  .controller{
    font-family: Kaiti,Yahei,sans-serif;
    font-size: 3.2rem;
    font-style: oblique;
  }
  .panel-c-c{
