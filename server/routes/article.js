...
// 创建一篇文章
router.post('/article/create',checkToken,(req,res,next)=>{
...
// 获取所有文章(带分页获取,需要验证权限)
router.post('/article/lists',checkToken,(req,res,next)=>{
...
router.post('/article/onePage',checkToken,(req,res,next)=>{
  let {id}  =req.body
...
router.post('/article/noAuth',(req,res,next)=>{
  let {id}  =req.body
  api.getOneArticle(id)
      .then((oneArticle)=>{
        if(oneArticle){
...
// 删除一篇文章
router.post('/article/remove',checkToken,(req,res,next)=>{
...
// 编辑文章
router.post('/article/edit',checkToken,(req,res,next)=>{
